...
\PassOptionsToPackage{left=0.1in,right=1in,top=0.5in,bottom=1in}{geometry}
\usepackage{marvosym}
...
\begin{tabular}{r|p{16cm}}
 ...
 \item Built a chatbot framework to listen messages from social channel, augment it with our analysis engine and run the business defined conversation logic.
 \item Wrote analytics engine which helped improve the bot performance for Manchester City Football Club.
 \item Wrote performance crucial announcement engine which is being used by Mancity to send matchday updates to thousands of subscribers in seconds.
 \end{itemize}
