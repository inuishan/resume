...
\begin{tabular}{r|p{16cm}}
 ...
 \item did bla
 \end{itemize}
 Built the technology from ground up. Built a chatbot framework to listen messages from social channel, augment it with our analysis engine and run the business defined conversation logic. Wrote analytics engine for Morph.ai.
